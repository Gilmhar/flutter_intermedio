...
class _CuadradoAnimadoState extends State<_CuadradoAnimado>
  ...
  void initState() {
    ...
    moverArriba = Tween(begin: 0.0, end: -100.0)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.25, 0.5, curve: Curves.bounceOut)));
    moverIzquierda = Tween(begin: 0.0, end: -100.0)
        .animate(CurvedAnimation(parent: controller!, curve: const Interval(0.5, 0.75, curve: Curves.bounceOut)));
